...
public class PagerAdapter extends RecyclerView.Adapter<PagerAdapter.MyViewHolder> {
    private List<NetAudioBean.ListEntity> mItems = new ArrayList<>();
    ...
    public void setDatas(List<NetAudioBean.ListEntity> datas) {
        datas.clear();
        datas.addAll(datas);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        NetAudioBean.ListEntity item = mItems.get(position);
